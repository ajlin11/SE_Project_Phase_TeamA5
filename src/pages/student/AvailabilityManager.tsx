...
const AvailabilityManager: React.FC = () => {
  ...
  const addSlot = async () => {
    ...
    try {
      const res = await studentApi.setAvailability(
        studentId,
        updated.map((s) => ({
          dayOfWeek: s.dayOfWeek,
          startTime: s.startTime,
          endTime: s.endTime,
          busy: s.busy ?? s.isBusy ?? false,
  ...
  return (
    <div>
      ...
      <p className="text-muted" style={{ marginBottom: 20 }}>
        Mark your busy slots (class times) so TESS can show you only jobs that
        fit your schedule.
      </p>
        ...
        <div className="card">
          ...
          <div className="form-group">
            ...
            <select
              ...
              onChange={(e) =>
                setForm({
                  ...form,
                  dayOfWeek: e.target.value as AvailabilityDay,
                })
              }
            >
              {DAYS.map((d) => (
          ...
          <div className="form-group">
            ...
            <select
              ...
              onChange={(e) =>
                setForm({ ...form, busy: e.target.value === "busy" })
              }
            >
        ...
        <div className="card">
          ...
          {slots.length === 0 ? (
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              {DAYS.filter((d) => slots.some((s) => s.dayOfWeek === d)).map(
                (day) => (
                  <div key={day}>
                    <div
                      style={{
                      ...
                      .map((slot) => (
                        <div
                          ...
                          style={{
                            ...
                            alignItems: "center",
                            padding: "6px 10px",
                            background: slot.busy ? "#fee2e2" : "#d1fae5",
                            borderRadius: 6,
                            marginBottom: 4,
                          }}
                        >

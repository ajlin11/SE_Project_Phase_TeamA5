...
## Project Title:  
TESS (Tirana Employment Service for Students)

## Problem Statement:
Students in Tirana often face difficulties in finding part-time jobs that fit their academic schedules. At the same time, companies struggle to find suitable student employees whose availability aligns with job requirements. Existing job platforms do not consider students' class schedules, leading to conflicts and inefficiencies in hiring.
...
The aim of the project is to design and develop a smart and user-friendly platform that connects students with part-time job opportunities based on their schedules and skills, improving employment efficiency for both students and employers.
...
- Receive notifications regarding job updates and interview invitations

The system ensures that students are only shown job opportunities that do not conflict with their academic schedule, improving efficiency and reducing scheduling conflicts.

## Employers (Companies)

Employers are companies that register on the platform to find suitable student workers. After creating an account, employers can manage their company profile and post job opportunities.

Employers are able to:
- Create and manage job postings with detailed descriptions
...
- Monitor job postings and remove inappropriate content
- Oversee system activity and ensure compliance with platform rules
- Maintain platform stability and security

## Key Features of the Application

The system integrates multiple modules into a unified platform, including:
...
- Reviewing team progress and contributions  
